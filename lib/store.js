...
export function AppDataProvider({ children }) {
  ...
  // /login and /q/[id] are public pages with no session cookie — fetching
  // here would just be a guaranteed 401. /q/[id] fetches its own data
  // directly from the public API instead (see app/q/[id]/page.js).
  const isPublicRoute = pathname === "/login" || pathname?.startsWith("/q/");
